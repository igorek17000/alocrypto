...
?>
            <!-- <div class="rcorners1">
                <label style="font-size:24px;">A</label>
            </div> -->
            <!-- or this -->
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <!-- Invest -->
                        <label id="inv" style="cursor: pointer;" class="nav_link"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <!-- transaction -->
                        <label id="tran" style="cursor: pointer;" class="nav_link"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <!-- profile -->
                        <label id="prof" style="cursor: pointer;" class="nav_link"><svg xmlns="http://www.w3.org/2000/svg" width="16"
